import { prisma, AttendanceStatus } from "../../../prisma/client.js";
...
export class AttendanceService {
    ...
    static async upsertAttendance(employeeId: string, data: any, actorId: string) {
    ...
    static async getSummary(employeeId: string, month: number, year: number) {
        ...
        const complianceRate = workingDays > 0 ? Math.round((compliantCount / workingDays) * 100) : 0;
